...
```{r plot-all-states, fig.wide = TRUE, fig.cap = "Progression of cases between states. Day 0 for each state is the first day where the number of cases reaced 100.", echo=FALSE, warning=FALSE, message=FALSE}
